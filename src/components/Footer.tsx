export function Footer() {
  const footerLinks = {
    "Архивы": ["Все архивы", "По именам", "По датам", "По категориям", "Избранное"],
    "Материалы": ["Фотографии", "Документы", "Видео", "Аудио", "Тексты"],
    "О проекте": ["О нас", "История", "Команда", "Контакты"],
    "Помощь": ["Документация", "Как добавить архив", "Конфиденциальность", "Условия"],
    "Связаться": ["Контакты", "Сообщество", "Email"],
  }
